...
function EventsNIRightSideBox() {
  return (
    <div className="RightSide-Box">
      ...
      />
      <Text
        class="NoIntegrationHeading3 heading-text"
        name="Connec google forms"
      />
      <Text
...
export default EventsNIRightSideBox;
